 ...
 * @author Advocacia-Geral da União <supp@agu.gov.br>
 */
class Usuario implements CoreUserInterface, EquatableInterface, Serializable, EntityInterface, UserInterface, EncoderAwareInterface
{
    // Traits
    use Blameable;
    use Timestampable;
    ...
    /**
     * @var Collection|ArrayCollection<LogRequest>
     *
     * @ORM\OneToMany(
     *     targetEntity="LogRequest",
     *     mappedBy="usuario",
     * )
     */
    ...
    /**
     * @var Collection|ArrayCollection<LogLogin>
     *
     * @ORM\OneToMany(
     *     targetEntity="LogLogin",
     *     mappedBy="usuario",
     * )
     */
    protected $logsLogin;
    ...
    /**
     * @var Collection|ArrayCollection<LogLoginFailure>
     * @ORM\OneToMany(
     *     targetEntity="LogLoginFailure",
     *     mappedBy="usuario",
     * )
     */
    ...
    /**
     * Getter for usuario request log collection.
     *
    ...
    /**
     * Getter for usuario login log collection.
     *
    ...
    /**
     * Getter for usuario login failure log collection.
     *
