...
class BarramentoSincronizacaoProcesso
{
    ...
    public function sincronizaProcesso(
        ...
        if (!$processoEntity) {
            ...
            // verifica se o processo ja foi remetido via barramento anteriormente,
            // caso contrario é processo com nro já existente na base e deve ser recusado
            ...
            if (!$tramitacaoBarramento) {
                throw new Exception('Processo '.$processoEntity->getNUPFormatado().' já existente na base do SUPER.br');
            }
        }
