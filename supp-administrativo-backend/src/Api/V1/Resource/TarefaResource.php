...
/** @noinspection MagicMethodsValidityInspection */
    ...
    public function iniciaProximaTarefaWorkflow(
        Entity $tarefaAtual,
        Setor $setorResponsavel,
        ?Usuario $usuarioResponsavel = null
    ): EntityInterface
    {
//        $transicaoWorkflowAtual = $this->transicaoWorkflowRepository
//            ->findTransicaoByWorkflowIdAndEspecieTarefaFromIdAndEspecieAtividadeId(
//                $tarefaAtual->getVinculacaoWorkflow()->getWorkflow()->getId(),
//                $tarefaAtual->getEspecieTarefa()->getId(),
//
//            )
//        $tarefaDTO = (new Tarefa())
//            ->setVinculacaoWorkflow($tarefaAtual->getVinculacaoWorkflow())
//            ->setSetorOrigem($tarefaAtual->getSetorResponsavel())
//            ->setSetorResponsavel($setorResponsavel)
//            ->setUsuarioResponsavel($usuarioResponsavel)
//            ->setDistribuicaoAutomatica(!$usuarioResponsavel)
//            ->setEspecieTarefa(
//                $tarefaAtual->getVinculacaoWorkflow()->getTransicaoWorkflowAtual()->getEspecieTarefaTo()
//            );
        dd(111);
    }
}
