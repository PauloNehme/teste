...
class Rule0002 implements RuleInterface
{
    ...
    public function validate(
        ...
        if ($this->authorizationChecker->isGranted('ROLE_ADMIN') && $entity->getModalidadeModelo()->getValor()
            !== $this->parameterBag->get('constantes.entidades.modalidade_modelo.const_4')) {
