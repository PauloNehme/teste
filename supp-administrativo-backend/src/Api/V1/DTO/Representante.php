...
class Representante extends RestDto
{
     ...
     *     message="Formato deve ser CCDDDDDDDC, sendo os primeiros 'C' a UF,
     *              os 'D' seguintes o número da inscrição, devendo incluir zeros ('0')
     *              à esquerda e o último 'C' a letra identificadora do tipo de inscrição"
     * )
     *
     * @Filter\StripTags()
     * @Filter\Trim()
