...
return static function (ContainerConfigurator $containerConfigurator): void {
    $imports = [
        '/vendor-bin/ecs/vendor/symplify/easy-coding-standard/config/set/psr12.php',
        '/vendor-bin/ecs/vendor/symplify/easy-coding-standard/config/set/clean-code.php',
        '/vendor-bin/ecs/vendor/symplify/easy-coding-standard/config/set/common.php',
        '/vendor-bin/ecs/vendor/symplify/easy-coding-standard/config/set/symfony.php',
        '/vendor-bin/ecs/vendor/symplify/easy-coding-standard/config/set/symfony-risky.php',
    ];
